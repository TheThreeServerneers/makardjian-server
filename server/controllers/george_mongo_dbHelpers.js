...
mongoose.connect('mongodb://george:password@18.219.152.205:27017/product_overview', { poolSize: 10, useNewUrlParser: true });
...
const firstPost = (req, res) => {
  ...
  Products.create(product)
    ...
    .catch((err) => {
      console.log(err + 'here in failure');
      res.send(500);
    });
};
